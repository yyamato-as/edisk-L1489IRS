...
vis_path = "/raid/work/yamato/edisk_data/L1489IRS/eDisk_calibrated_data/"



#pick up extracted MSes from the archived data
vislist=glob.glob(vis_path+'*spectral_line.ms')
vislist_sb=glob.glob(vis_path+'*SB*spectral_line.ms')
vislist_lb=glob.glob(vis_path+'*LB*spectral_line.ms')
