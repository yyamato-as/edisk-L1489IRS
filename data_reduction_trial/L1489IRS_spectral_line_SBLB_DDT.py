...
for i in data_params.keys():
    ...
    # SB data (DDT) do not have cont.dat, so spw5 is continuum only and does not have any flagged channels
    if "SB" in i:
        spws_string = '0, 1, 2, 3, 4, 6'
    print(spws_string)
...
image_list_sb = {
        ...
        ### 12CO images
        "12CO":dict(chanstart='-100.0km/s', chanwidth='0.635km/s', 
            nchan=315, linefreq='230.538GHz', linespw='5',
            robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### SO Images
        "SO":dict(chanstart='-5.5km/s', chanwidth='0.167km/s', 
            nchan=120, linefreq='219.94944200GHz', linespw='2',
        ...
        "H2CO_3_21-2_20_218.76GHz":dict(chanstart='-5.5km/s', 
            chanwidth='0.167km/s', nchan=120, linefreq='218.76006600GHz', 
            linespw='0', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### H2CO 3(0,3)-2(0,2) Images
        "H2CO_3_03-2_02_218.22GHz":dict(chanstart='-10km/s',
            chanwidth='1.34km/s', nchan=23, linefreq='218.22219200GHz', 
            linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### H2CO 3(2,2)-2(2,1) Images
        "H2CO_3_22-2_21_218.47GHz":dict(chanstart='-10km/s', 
            chanwidth='1.34km/s', nchan=23, linefreq='218.47563200GHz',
            linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### c-C3H2 217.82 GHz Images
        "c-C3H2_217.82":dict(chanstart='-10km/s', chanwidth='1.34km/s', 
            nchan=23, linefreq='217.82215GHz', linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### c-C3H2 217.94 GHz Images
        "c-C3H2_217.94":dict(chanstart='-10km/s', chanwidth='1.34km/s', 
            nchan=23, linefreq='217.94005GHz', linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### c-C3H2 218.16 GHz Images
        "c-C3H2_218.16":dict(chanstart='-10km/s', chanwidth='1.34km/s', 
            nchan=23, linefreq='218.16044GHz', linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### DCN Images
        "DCN":dict(chanstart='-10km/s', chanwidth='1.34km/s', nchan=23, 
            linefreq='217.2386GHz', linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### CH3OH Images
        "CH3OH":dict(chanstart='-10km/s', chanwidth='1.34km/s', nchan=23, 
            linefreq='218.44006300GHz', linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### SiO Images
        "SiO":dict(chanstart='-100km/s', chanwidth='1.34km/s', nchan=150, 
            linefreq='217.10498000GHz', linespw='4', robust=[0.5],imsize=1600,cellsize='0.025arcsec')
        }
...
###############################################################
import sys
sys.argv = ['/home/yamato/Project/edisk/plot_final_images_SBLB.py', prefix]
execfile('/home/yamato/Project/edisk/plot_final_images_SBLB.py')
